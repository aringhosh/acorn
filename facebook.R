...
#access_token <- "EAACEdEose0cBAOh6YPzZCBQSoSYAdJxZBFQeDzEdCgnF3wZCLSeOgS43RRhZBuEe9JbvOfAQwimKkMucOnLHILf3C8r4BuoeKPjZAckFDZCPRv0eHGqfZC3HGR057ynjWCLux94QXkzO5mHFlBAcPAQVCfMwXcZCRdBk6hC68MSxdQZDZD"

access_token <- readLines("fbaccess")
...
if(nrow(df) != 0) #only if there is any link to analyze
{
  ...
  print("No FB links present - exporting empty data frame")
}
